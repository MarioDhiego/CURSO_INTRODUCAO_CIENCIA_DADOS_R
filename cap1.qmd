...
1)  base : funcoes básicas e preinstaladas e carregadas;

-   

2)  recommended : funcoes instaladas mas nao carregadas, Necessário usar o comando *libray()*;

-   

3)  contributed : pacotes que nao são instalados automaticamente usa o comando *install.package()*;
